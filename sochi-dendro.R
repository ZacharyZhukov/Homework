...
station_data = read.csv(str_interp("station_data.csv"))
...
station_list = meteo_nearby_stations(lat_lon_df = sochi, station_data = stations,
                                        limit = 20, var = c("PRCP"),
                                        year_min = 2008, year_max = 2019)
...
sochi_id = station_list$Sochi$id[1]
...
#  1  2013     926.   153 2009     667.   153 по n все данные есть!
...
search2 = rLandsat::landsat_search(min_date = "2008-05-01", 
                                   max_date = "2019-09-30", 
...
ls8t = readMeta(str_interp(" "))
lsst = stackMeta(str_interp(" "))
