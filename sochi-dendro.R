...
search2 = rLandsat::landsat_search(min_date = "2013-09-01", 
                                   max_date = "2013-10-30", 
...
# Долгая операция
search_result_download(search_result[7,])
...
ls8t = readMeta(str_interp("Downloads/landsat/LC81740292013281LGN00/LC81740292013281LGN00_MTL.txt"))
lsst = stackMeta(str_interp("Downloads/landsat/LC81740292013281LGN00/LC81740292013281LGN00_MTL.txt"))
